    ...
    <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8">
      <div class="bg-white rounded-lg shadow-sm p-6 border-l-4 border-yellow-500">
        <div class="flex items-center justify-between">
          <div>
            <p class="text-sm text-gray-500">{{ $t('admin.guestApproval.stats.pending') }}</p>
      ...
      <div class="bg-white rounded-lg shadow-sm p-6 border-l-4 border-green-500">
        <div class="flex items-center justify-between">
          <div>
            <p class="text-sm text-gray-500">{{ $t('admin.guestApproval.stats.approved') }}</p>
      ...
      <div class="bg-white rounded-lg shadow-sm p-6 border-l-4 border-red-500">
        <div class="flex items-center justify-between">
          <div>
            <p class="text-sm text-gray-500">{{ $t('admin.guestApproval.stats.rejected') }}</p>
...
// 處理申請批准
function handleRequestApproved(request: GuestRequestResponse) {
  loadStats()
}

// 處理申請拒絕
function handleRequestRejected(request: GuestRequestResponse) {
  loadStats()
}
